...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { email: @passenger.email, flight_id: @passenger.flight_id, name: @passenger.name, phone: @passenger.phone } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { email: @passenger.email, flight_id: @passenger.flight_id, name: @passenger.name, phone: @passenger.phone } }
